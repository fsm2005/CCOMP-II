...
string transmutar(int num) {
    ...
    // Manejo de centenas de mil (100000 a 999999)
    if (num >= 100000) {
        int centenasMil = num / 100000;
        resul += centenas[centenasMil] + " ";
        num %= 100000;
    }
    if (num >= 21000 && num < 22000) { // Manejo de números entre 21000 y 21999
        resul += "Veintiun Mil ";
        num %= 1000;
    }
    // Manejo de decenas de mil (20000 a 99999)
    if (num >= 20000) {
        int decenasMil = num / 10000;
        int unidadesMil = (num / 1000) % 10;

        if (decenasMil == 2 && unidadesMil > 0) { // Caso especial para 21, 22, 23, ..., 29 mil
    ...
    else if (num >= 10000) { // Manejo de números entre 10000 y 19999
        int miles = (num / 1000) % 10;
        resul += problema[miles] + " Mil ";
        num %= 1000;
    }

    // Manejo de unidades de mil (1000 a 9999)
    if (num >= 1000) {
    ...
    // Manejo de decenas (20 a 99)
    if (num >= 20) {
        if (num / 10 == 2 && num % 10 > 0) { // Caso especial para 21, 22, 23, ..., 29
    ...
    else if (num >= 10) { // Manejo de números entre 10 y 19
        return resul + problema[num - 10];
    }

    // Manejo de unidades (1 a 9)
    resul += unidades[num];
